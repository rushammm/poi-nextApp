      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Rusham Elahi", role: "Chief Data Scientist", image: "/images/team1.jpg" },
              { name: "Sara Johnson", role: "Urban Planning Expert", image: "/images/team2.jpg" },
              { name: "Michael Patel", role: "GIS Specialist", image: "/images/team3.jpg" }
            ].map((member, idx) => (
